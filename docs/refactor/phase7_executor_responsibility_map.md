...
| Named runtime gate selection (updated 2026-08-17) | `runtime_gate_policy`, `runtime_reasons`, `publish_hold` | Executor checks are the single authority; immutable policies replace interacting booleans and the removed duplicate shadow evaluator. |
