...
- `piper_ros_foxy/src/piper_mobile_manipulation/piper_mobile_manipulation/scan_target_acquisition_node.py`: `acquisition_camera_pitch_deg`, `acquisition_viewpoints_topic`, `base_frame`, `camera_optical_frame`, `dry_run`, `future_tolerance_sec`, `handoff_retry_sec`, `handoff_timeout_sec`, `hint_max_age_sec`, `include_compact_candidates`, `minimum_standoff_m`, `reachable_acquisition_viewpoints_topic`, `request_acquisition_plan_service`, `sweep_angle_deg`, `transform_timeout_sec`.
