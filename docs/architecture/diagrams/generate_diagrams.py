...
def render_system():
    ...
    nodes = {
        ...
        "curobo": dict(x=690, y=2650, w=500, h=205, title="cuRobo 0.7.8 MotionGen worker", lines=("Python 3.10 + CUDA; ROS-free", "exact fixed Bunker meshes", "69-sphere articulated approximation", "operator-qualified for supervised 5% test", "no automatic Tesseract fallback"), color="optional", status="LIMITED GEOMETRY"),
    ...
    edges = [
        ...
        dict(src="bridge", dst="curobo", kind="optional", label="qualified supervised 5%", src_at=(800, 2625), dst_at=(940, 2650), via=((800, 2637), (940, 2637)), label_at=(870, 2633)),
    ...
    body.extend(section(2325, 3100, "5  Propose motion through one frozen backend", "Both backends are integrated; cuRobo is qualified for supervised 5% target scans."))
...
def render_planner():
    nodes = {
        ...
        "curobo": dict(x=645, y=850, w=400, h=200, title="cuRobo 0.7.8 worker", lines=("MotionGen plan_single / plan_single_js", "exact fixed meshes + 69 moving spheres", "CUDA/Python 3.10 isolated", "hardware_qualified=true", "coverage limits remain documented"), color="optional", status="SUPERVISED 5%"),
    ...
    edges = [
        ...
        dict(src="bridge", dst="curobo", kind="optional", label="qualified supervised 5%", src_side="bottom", dst_side="top"),
    ...
    render_flow(
        ...
        "What is common, each backend's qualification scope, and how readiness and rejection return to the mission",
        nodes,
        edges,
        1850,
